...
class QdjangoViewsTest(QdjangoTestBase):
    ...
    def test_QdjangoLayerDataView(self):
        ...
        # check for info_result_number_fields default value
        self.assertEqual(layer.info_result_number_fields, 3)
        ...
        # Add for info_result_number_fields
        data_post['info_result_number_fields'] = 5
        ...
        # check for info_result_number_fields
        self.assertEqual(layer.info_result_number_fields, 5)
