    ...
    def test_layers(self):
        ...
        for layer in self.project.layers:
            if layer.layerId == 'countries_simpl20171228095706310':
                ...
                self.assertEqual(layer.extent.upper(), 'POLYGON((-31.26574700000000462 32.3974759999999975, 69.07032000000000949 32.3974759999999975, 69.07032000000000949 81.85736800000000812, -31.26574700000000462 81.85736800000000812, -31.26574700000000462 32.3974759999999975))')
            ...
            if layer.layerId == 'cities10000eu20171228095720113':
                ...
                # check extent
                self.assertEqual(layer.extent.upper(), 'POLYGON((-9.71666669999999932 35.00999999999999801, 57.35194440000000071 35.00999999999999801, 57.35194440000000071 69.96666670000000465, -9.71666669999999932 69.96666670000000465, -9.71666669999999932 35.00999999999999801))')
