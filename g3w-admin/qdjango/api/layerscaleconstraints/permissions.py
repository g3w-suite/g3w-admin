...
class ScaleVisibilityLayerConstraintPermission(BasePermission):
    """
    API permission for ScaleVisibilityLayerConstraint urls
        ...
        try:
            if request.method in ('POST'):
                ...
                if 'pk' in view.kwargs:
                    layer = ScaleVisibilityLayerConstraint.objects.get(
