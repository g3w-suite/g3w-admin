...
from qdjango.views import ListView, CreateView
...
class QdjangoMessageListView(MessageACLMixin, G3WRequestViewMixin, G3WGroupViewMixin, QdjangoProjectViewMixin, ListView):
    """
...
# class QdjangoMessageListView(MessageACLMixin, G3WRequestViewMixin, G3WGroupViewMixin, QdjangoProjectViewMixin, CreateView):
#     """
