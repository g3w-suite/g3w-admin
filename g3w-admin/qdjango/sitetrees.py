...
sitetrees = (
  ...
  G3Wtree('qdjango', title='Qdjango', module='qdjango', items=[
      ...
      item('Aggiungi progetto qdjango {{ group.slug }}', 'qdjango-project-add group.slug', in_menu=False,
           url_as_pattern=True, icon_css_class='fa fa-plus', access_by_perms=['qdjango.add_project']),
      item('Agg. progetto qdjango {{ group.slug }} {{ object.slug }}', 'qdjango-project-update group.slug object.slug',
           in_menu=False, url_as_pattern=True, icon_css_class='fa fa-edit'),
      item('Lista strati progetto qdjango {{ group.slug }} {{ object.slug }}', 'qdjango-project-layers-list group.slug project_slug',
           in_menu=False, url_as_pattern=True, icon_css_class='fa fa-edit')
  ]),
