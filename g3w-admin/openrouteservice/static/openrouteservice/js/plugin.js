...
exports.default = {
    ...
    watch: {
        currentinputs: function currentinputs() {
            this.validate();
        },
        currentoutputs: function currentoutputs() {
            this.validate();
        }
    },
    mounted: function () {
...
function Service() {
  ...
  this.init = function () {
    ...
    var pointMulipointsLayers = ProjectsRegistry.getCurrentProject().state.layers.filter(function (layer) {
      return layer.geometrytype === "Point" || layer.geometrytype === "MultiPolint";
    }).map(function (layer) {
      return {
        key: layer.name,
        value: layer.id
    ...
    Object.keys(this.config).forEach(function (key) {
      if (key === 'isochrones') {
        ...
        _this.config[key].compatible.forEach(function (value) {
          return outputLayer.input.options.values.push({
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 8:
              ...
              message = GUI.errorToMessage(_context.t0);
