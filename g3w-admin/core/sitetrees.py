  ...
  # Define a tree with `tree` function.
    ...
    G3Wtree('core_en', title='Menu', module='core', items=[
        ...
        item('Cartographic groups', 'group-list', icon_css_class='fa fa-globe', children=[
            ...
            item('Trash', 'group-deactive-list', url_as_pattern=True, icon_css_class='fa fa-trash',
                 alias='group-deactive-list', in_breadcrumbs=True),
            item('Groups update {{ object.title}}', 'group-update object.slug', url_as_pattern=True,
                 icon_css_class='fa fa-edit', in_menu=False, alias='group-update'),
            item('Projects list {{ group.name }}', 'project-list group.slug', url_as_pattern=True,
                 icon_css_class='fa fa-list', in_menu=False, in_breadcrumbs=True, alias='project-list')
        ]),
    ...
    G3Wtree('core_fr', title='Menu', module='core', items=[
        ...
        item('Groupes cartographiques', 'group-list', icon_css_class='fa fa-globe', children=[
            item('Ajouter un groupe', 'group-add', url_as_pattern=True, icon_css_class='fa fa-plus',
                 access_by_perms=['core.add_group']),
            item('Liste des groupes', 'group-list', url_as_pattern=True, icon_css_class='fa fa-globe',
                 alias='group-list', in_breadcrumbs=False),
            item('Pouble', 'group-deactive-list', url_as_pattern=True, icon_css_class='fa fa-trash',
                 alias='group-deactive-list', in_breadcrumbs=True),
            item('Mise à jour du groupe {{ object.title}}', 'group-update object.slug', url_as_pattern=True,
                 icon_css_class='fa fa-edit', in_menu=False, alias='group-update'),
            item('Liste des projets {{ group.name }}', 'project-list group.slug', url_as_pattern=True,
                 icon_css_class='fa fa-list', in_menu=False, in_breadcrumbs=True, alias='project-list')
        ]),
    ...
    G3Wtree('core_ro', title='Menu', module='core', items=[
      # Then define items and their children with `item` function.
        ...
        item('Grupuri cartografice', 'group-list', icon_css_class='fa fa-globe', children=[
          item('Adaugă grup', 'group-add', url_as_pattern=True, icon_css_class='fa fa-plus',
               access_by_perms=['core.add_group']),
          item('Listă grupuri', 'group-list', url_as_pattern=True, icon_css_class='fa fa-globe',
               alias='group-list', in_breadcrumbs=False),
          item('Coș de gunoi', 'group-deactive-list', url_as_pattern=True, icon_css_class='fa fa-trash',
               alias='group-deactive-list', in_breadcrumbs=True),
          item('Groups update {{ object.title}}', 'group-update object.slug', url_as_pattern=True,
               icon_css_class='fa fa-edit', in_menu=False, alias='group-update'),
          item('Lista proiecte {{ group.name }}', 'project-list group.slug', url_as_pattern=True,
               icon_css_class='fa fa-list', in_menu=False, in_breadcrumbs=True, alias='project-list')
        ]),
