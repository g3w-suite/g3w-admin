...
},{"./config/config.js":1,"./template/js/contents":12,"./template/js/template":16,"sdk":93,"sdk/sdk":93}],4:[function(require,module,exports){
...
},{"../html/app.html":4,"./layout":14,"core/applicationservice":19,"core/project/projectsregistry":41}],11:[function(require,module,exports){
...
},{"sdk/core/g3wobject":29,"sdk/core/utils/utils":48}],12:[function(require,module,exports){
...
},{"../html/contents.html":5,"core/i18n/i18n.service":32,"core/utils/utils":48,"gui/vue/component":91}],13:[function(require,module,exports){
...
},{"../html/floatbar.html":6,"./barstack.js":11,"sdk/core/i18n/i18n.service":32,"sdk/gui/gui":72}],14:[function(require,module,exports){
...
},{"../html/sidebar-item.html":7,"../html/sidebar.html":8,"./barstack.js":11,"sdk/core/i18n/i18n.service":32}],16:[function(require,module,exports){
var t = require('sdk/core/i18n/i18n.service').t;
...
},{"./applicationui":10,"./floatbar":13,"./layout":14,"./sidebar":15,"./viewport":17,"core/g3wobject":29,"core/utils/utils":48,"sdk/core/i18n/i18n.service":32,"sdk/gui/componentsregistry":69,"sdk/gui/gui":72,"sdk/gui/vue/vue.directives":92}],17:[function(require,module,exports){
...
},{"../html/viewport.html":9,"sdk":93}],18:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
var base = require('core/utils/utils').base;
var G3WObject = require('core/g3wobject');
...
},{"core/g3wobject":29,"core/utils/utils":48}],19:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
var base = require('core/utils/utils').base;
var G3WObject = require('core/g3wobject');
...
},{"core/apiservice":18,"core/g3wobject":29,"core/plugin/pluginsregistry":38,"core/project/projectsregistry":41,"core/router":46,"core/utils/utils":48}],20:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
var G3WObject = require('core/g3wobject');
...
},{"core/g3wobject":29,"core/utils/utils":48}],21:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
var base = require('core/utils/utils').base;
...
},{"./editbuffer":20,"./tools/addfeaturetool":22,"./tools/cutlinetool":23,"./tools/deletefeaturetool":24,"./tools/modifyfeaturetool":26,"./tools/movepointtool":27,"./tools/pickfeaturetool":28,"core/g3wobject":29,"core/map/layer/vectorlayer":34,"core/utils/utils":48,"gui/gui":72}],22:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
var base = require('core/utils/utils').base;
var G3WObject = require('core/g3wobject');
...
},{"./editingtool":25,"core/g3wobject":29,"core/utils/utils":48}],23:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
var base = require('core/utils/utils').base;
...
},{"./editingtool":25,"core/geometry/geom":30,"core/utils/utils":48,"g3w-ol3/src/interactions/pickcoordinatesinteraction":57,"g3w-ol3/src/interactions/pickfeatureinteraction":58}],24:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
var base = require('core/utils/utils').base;
var G3WObject = require('core/g3wobject');
...
},{"./editingtool":25,"core/g3wobject":29,"core/utils/utils":48,"g3w-ol3/src/interactions//deletefeatureinteraction":56}],25:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
var base = require('core/utils/utils').base;
var G3WObject = require('core/g3wobject');
...
},{"core/g3wobject":29,"core/utils/utils":48}],26:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
var base = require('core/utils/utils').base;
var G3WObject = require('core/g3wobject');
...
},{"./editingtool":25,"core/g3wobject":29,"core/utils/utils":48}],27:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
var base = require('core/utils/utils').base;
...
},{"./editingtool":25,"core/utils/utils":48}],28:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
var base = require('core/utils/utils').base;
...
},{"./editingtool":25,"core/utils/utils":48,"g3w-ol3/src/interactions/pickfeatureinteraction":58}],29:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
var noop = require('core/utils/utils').noop;
...
},{"core/utils/utils":48}],30:[function(require,module,exports){
var geom = {
...
},{"core/g3wobject":29,"core/utils/utils":48}],34:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
...
},{"core/g3wobject":29,"core/utils/utils":48}],35:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
var base = require('core/utils/utils').base;
...
},{"core/map/layer/maplayer":33,"core/utils/geo":47,"core/utils/utils":48,"g3w-ol3/src/layers/rasters":60}],36:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
var base = require('core/utils/utils').base;
var G3WObject = require('core/g3wobject');
...
},{"core/g3wobject":29,"core/utils/utils":48}],37:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
var base = require('core/utils/utils').base;
var G3WObject = require('core/g3wobject');
...
},{"core/g3wobject":29,"core/utils/utils":48}],38:[function(require,module,exports){
var base = require('core/utils/utils').base;
var inherit = require('core/utils/utils').inherit;
var G3WObject = require('core/g3wobject');
var ApplicationService = require('core/applicationservice');
...
},{"core/applicationservice":19,"core/g3wobject":29,"core/utils/utils":48}],39:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
var base = require('core/utils//utils').base;
var G3WObject = require('core/g3wobject');
var ApplicationService = require('core/applicationservice');
...
},{"./projectlayer":40,"core/applicationservice":19,"core/g3wobject":29,"core/utils//utils":48,"core/utils/utils":48}],40:[function(require,module,exports){
...
},{"core/geometry/geometry":31}],41:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
var base = require('core/utils/utils').base;
var resolve = require('core/utils/utils').resolve;
var reject = require('core/utils/utils').reject;
...
},{"core/g3wobject":29,"core/project/project":39,"core/utils/utils":48}],42:[function(require,module,exports){
var ProjectTypes = {
  QDJANGO: 'qdjango',
  OGR: 'ogr'
};
...
},{"core/g3wobject":29,"core/project/projectsregistry":41,"core/utils/utils":48}],44:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
var base = require('core/utils/utils').base;
var G3WObject = require('core/g3wobject');
var resolve = require('core/utils/utils').resolve;
...
},{"core/g3wobject":29,"core/utils/utils":48}],45:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
var base = require('core/utils/utils').base;
var G3WObject = require('core/g3wobject');
var ProjectsRegistry = require('core/project/projectsregistry');
...
},{"./queryQGISWMSProvider":43,"./queryWFSProvider":44,"core/g3wobject":29,"core/project/projectsregistry":41,"core/utils/utils":48,"sdk/gui/componentsregistry":69}],46:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
var base = require('core/utils/utils').base;
...
},{"core/g3wobject":29,"core/utils/utils":48}],47:[function(require,module,exports){
...
},{"../interactions/pickcoordinatesinteraction":57,"../utils":62,"./interactioncontrol":50}],53:[function(require,module,exports){
var utils = require('../utils');
var InteractionControl = require('./interactioncontrol');
...
},{"../utils":62,"./interactioncontrol":50}],54:[function(require,module,exports){
var utils = require('../utils');
var InteractionControl = require('./interactioncontrol');
...
},{"../utils":62,"./interactioncontrol":50}],55:[function(require,module,exports){
var utils = require('./utils');
...
},{"./map/maphelpers":61,"./utils":62}],56:[function(require,module,exports){
...
},{"../layers/bases":59}],62:[function(require,module,exports){
var utils = {
...
},{"./catalog.html":63,"./legend.html":65,"./legend_item.html":66,"./tristate-tree.html":67,"core/i18n/i18n.service":32,"core/project/projectsregistry":41,"core/utils/utils":48,"gui/gui":72,"gui/vue/component":91}],65:[function(require,module,exports){
...
},{"core/g3wobject":29,"core/utils/utils":48}],69:[function(require,module,exports){
var G3WObject = require('core/g3wobject');
var inherit = require('core/utils/utils').inherit;
var base = require('core/utils/utils').base;
...
},{"core/g3wobject":29,"core/utils/utils":48}],70:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
var resolve = require('core/utils/utils').resolve;
var reject = require('core/utils/utils').reject;
var GUI = require('gui/gui');
...
},{"./formpanel.html":71,"core/query/queryservice":45,"core/utils/utils":48,"g3w-ol3/src/interactions/pickcoordinatesinteraction":57,"gui/gui":72,"gui/panel":79}],71:[function(require,module,exports){
...
},{"core/g3wobject":29,"core/utils/utils":48,"gui/componentsregistry":69}],73:[function(require,module,exports){
module.exports = "<div>\n  Lista di oggetti\n</div>\n";
...
},{"./listpanel.html":73,"core/utils/utils":48,"gui/gui":72}],75:[function(require,module,exports){
...
},{"g3w-ol3/src/controls/olcontrol":51,"g3w-ol3/src/controls/querycontrol":52,"g3w-ol3/src/controls/resetcontrol":53,"g3w-ol3/src/controls/zoomboxcontrol":54}],76:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
var base = require('core/utils/utils').base;
var G3WObject = require('core/g3wobject');
var GUI = require('gui/gui');
...
},{"core/applicationservice":19,"core/g3wobject":29,"core/geometry/geometry":31,"core/map/layer/wmslayer":35,"core/project/projectsregistry":41,"core/project/projecttypes":42,"core/query/queryservice":45,"core/utils/utils":48,"g3w-ol3/src/g3w.ol3":55,"gui/gui":72,"gui/map/control/factory":75}],77:[function(require,module,exports){
...
},{"../mapservice":76,"./map.html":77,"core/i18n/i18n.service":32,"core/map/mapsregistry":36,"core/router":46,"core/utils/utils":48,"g3w-ol3/src/g3w.ol3":55,"gui/gui":72,"gui/vue/component":91}],79:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
...
},{"core/g3wobject":29,"core/utils/utils":48}],80:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
var base = require('core/utils/utils').base;
var GUI = require('gui/gui');
var G3WObject = require('core/g3wobject');
...
},{"core/g3wobject":29,"core/project/projectsregistry":41,"core/utils/utils":48,"gui/componentsregistry":69,"gui/gui":72}],81:[function(require,module,exports){
...
},{"./queryresults.html":81,"core/g3wobject":29,"core/utils/utils":48,"gui/queryresults/queryresultsservice":80,"gui/vue/component":91}],83:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
var GUI = require('gui/gui');
var ProjectsRegistry = require('core/project/projectsregistry');
var G3WObject = require('core/g3wobject');
...
},{"core/g3wobject":29,"core/project/projectsregistry":41,"core/utils/utils":48,"gui/gui":72,"gui/search/vue/panel/searchpanel":85}],84:[function(require,module,exports){
...
},{"./searchpanel.html":84,"core/i18n/i18n.service":32,"core/project/projectsregistry":41,"core/query/queryservice":45,"core/utils/utils":48,"gui/gui":72,"gui/listpanel":74,"gui/panel":79}],86:[function(require,module,exports){
...
},{"./search.html":86,"core/g3wobject":29,"core/i18n/i18n.service":32,"core/project/projectsregistry":41,"core/utils/utils":48,"gui/gui":72,"gui/search/searchesservice":83,"gui/search/vue/panel/searchpanel":85,"gui/vue/component":91}],88:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
var base = require('core/utils/utils').base;
var G3WObject = require('core/g3wobject');
...
},{"core/g3wobject":29,"core/utils/utils":48}],89:[function(require,module,exports){
...
},{"./tools.html":89,"core/i18n/i18n.service":32,"core/utils/utils":48,"gui/tools/toolsservice":88,"gui/vue/component":91}],91:[function(require,module,exports){
var inherit = require('core/utils/utils').inherit;
var base = require('core/utils/utils').base;
var resolve = require('core/utils/utils').resolve;
var reject = require('core/utils/utils').reject;
...
},{"core/utils/utils":48,"gui/component":68}],92:[function(require,module,exports){
...
},{"core/apiservice":18,"core/applicationservice":19,"core/editing/editor":21,"core/g3wobject":29,"core/geometry/geom":30,"core/geometry/geometry":31,"core/i18n/i18n.service":32,"core/map/layer/maplayer":33,"core/map/layer/vectorlayer":34,"core/map/layer/wmslayer":35,"core/plugin/plugin":37,"core/plugin/pluginsregistry":38,"core/project/project":39,"core/project/projectsregistry":41,"core/query/queryservice":45,"core/router":46,"core/utils/utils":48,"g3w-ol3/src/interactions/pickcoordinatesinteraction":57,"g3w-ol3/src/interactions/pickfeatureinteraction":58,"gui/catalog/vue/catalog":64,"gui/form":70,"gui/gui":72,"gui/map/vue/map":78,"gui/panel":79,"gui/queryresults/vue/queryresults":82,"gui/search/vue/search":87,"gui/tools/vue/tools":90}]},{},[3])


//# sourceMappingURL=data:application/json;base64,
