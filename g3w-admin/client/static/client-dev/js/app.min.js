...
function createApplicationConfig() {
  return {
    ...
    getWmsUrl: function(project){
      return config.server.urls.base_url+config.server.urls.ows+'/'+config.group.id+'/'+project.type+'/'+project.id;
    },
    // richiesto da ProjectsRegistry per acquisire informazioni specifiche del progetto
    getProjectConfigUrl: function(project){
      return config.server.urls.base_url+config.server.urls.config+'/'+config.group.id+'/'+project.type+'/'+project.id;
    },
...
var bootstrap = function() {
  ...
  .then(function(initConfig) {
    ...
    config.server.urls.base_url = initConfig.base_url;
