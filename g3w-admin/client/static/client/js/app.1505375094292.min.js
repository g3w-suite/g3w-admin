  ...
  */
  ...
  this.queryByLocation = function(coordinates, layers) {
    ...
    _.forEach(urlsForLayers,function(urlForLayers) {
      ...
      console.log(queryLayers[0]);
      var infoFormat = queryLayers[0].getInfoFormat();
      var params = {
        LAYERS: _.map(queryLayers,function(layer){ return layer.getId()}),
        QUERY_LAYERS: _.map(queryLayers,function(layer){ return layer.getId()}),
