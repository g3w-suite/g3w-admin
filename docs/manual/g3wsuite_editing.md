...
![Project title settings](../images/manual/en/editing_qgis_form_widget.png)
...
Identify the PostGreSQL/PostGis layer on which you want to activate the editing function and click on the Editing layer icon located on the left ![Project title settings](../images/manual/en/icon_editing.png)
...
![Project title settings](../images/manual/en/editing_setting.png)
...
To activate a geographical constraint, you must click, always at the level of the list of project layers, on the "Constraints list" icon ![Project title settings](../images/manual/en/icon_constraints_setting.png) which will appear once the online editing function is activated.
...
![Project title settings](../images/manual/en/editing_constrain_layer.png)
...
Once the layer has been defined, the constraint will appear in the list and can be parameterized using the Rules icon ![Project title settings](../images/manual/en/icon_constraints_setting.png)

Clicking on this icon will open a modal window which, by pressing the button ![Project title settings](../images/manual/en/button_add.png), it will allow you to define, for each user and/or group of users, the rules of the constraints.
...
The Save icon ![Project title settings](../images/manual/en/icon_save.png) will allow you to validate the SQL itself, in order to ensure proper functioning of the constraints itself.

Once all the constraints have been entered and validated, click on the Close button to confirm the rules.

![Project title settings](../images/manual/en/editing_constrain_setting.png)
...
![Project title settings](../images/manual/en/editing_client_start.png) ![Project title settings](../images/manual/en/editing_client_tool.png)
...
**Geometric layers**
 * ![Project title settings](../images/manual/en/icon_feature_add.png) **Add feature:** to add a feature
 * ![Project title settings](../images/manual/en/icon_feature_move.png) **Move feature**
 * ![Project title settings](../images/manual/en/icon_feature_modify.png) **Update feature vertex:** to modify the shape of a geometry
 * ![Project title settings](../images/manual/en/icon_feature_remove.png) **Remove feature**
 * ![Project title settings](../images/manual/en/icon_feature_attribute.png) **Modify feature:** to modify the attributes associated with an existing feature

Activating the **Add features** and **Update feature vertex** tools allows you to activate the snap intralayer function.

**Alphanumeric layer**
 * ![Project title settings](../images/manual/en/icon_record_add.png) **Add feature:** to add a record to the alphanumeric table
 * ![Project title settings](../images/manual/en/icon_record_modify.png) **Modify features:** to modify the attributes of an existing record
...
![Project title settings](../images/manual/en/editing_form.png)
...
For this reason the button ![Project title settings](../images/manual/en/buttom_save_simple.png) will be disabled until all constraints are met.

#### Saving changes
Saving all the changes made in an editing session can be done in two ways:
 * by clicking on the diskette icon ![Project title settings](../images/manual/en/icon_disk.png) placed at the top right. The changes made will be saved and you can continue making new changes
 * by deactivating the editing by clicking on the Edit layer icon ![Project title settings](../images/manual/en/icon_edit2.png). 
...
![Project title settings](../images/manual/en/editing_client_save.png)

Remember that during the editing phase the undo/redo icons ![Project title settings](../images/manual/en/icon_undoredo.png) allow you to delete/restore the latest changes made.
...
![Project title settings](../images/manual/en/editing_form2.png)
...
![Project title settings](../images/manual/en/editing_form_relations.png)
...
By clicking on the icon ![Project title settings](../images/manual/en/icon_plus.png) (located at the top right) it will be show the attribute form to insert a new record.
...
By clicking on the icon ![Project title settings](../images/manual/en/icon_join.png) (located at the top right) you can associate a record, already linked to other features or orphaned, to the edited feature.
 ...
 * ![Project title settings](../images/manual/en/icon_join_erase.png) Unlink relation: to dissociate the record from the edited feature, the record will not be deleted but will become an orphan
 * ![Project title settings](../images/manual/en/icon_record_erase.png) Delete feature: permanently delete the record
 * ![Project title settings](../images/manual/en/icon_record_attribute.png) Update feature: modify the values associated with the attributes of this record; the change must be validated by clicking on the Save button at the bottom of the form.
